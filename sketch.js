...
var SMWeb;
var restartimg , Restart , Startimg , Start , Titleimg , Title;
...
Titleimg = loadImage("./Animations/Loading Screen.png");
...
function setup() {
  ...
  Title = createSprite(500,200);
  Title.addImage("Write" , Titleimg);
  Title.visible = false;
